...
cls
echo.
echo       railo-builder-releng menu
REM echo       usage: railo-builder-releng.bat [start|stop|{target}]
echo.
...
echo to stop the server, run this again or run: railo-builder-releng.bat stop
goto end
::
:stopServer
